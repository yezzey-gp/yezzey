...
initdb -D $DB_PATH
echo yezzey.S3_putter = \'wal-g st put %f %s --config /home/fstilus/config.yaml -f\' >> $DB_PATH/postgresql.conf
echo yezzey.S3_getter = \'wal-g st get %f %s --config /home/fstilus/config.yaml\' >> $DB_PATH/postgresql.conf
